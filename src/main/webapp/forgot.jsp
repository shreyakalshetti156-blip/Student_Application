...
<body>
    <div class="page-container">
        <div class="password-container">
            <div class="logo-section">
                <div class="logo-img">
                    ...
                    <img src="https://play-lh.googleusercontent.com/8ZDxwWHQnKPHu3hJDN0whQqz8PDtpH1niWl_s6NIJ1Xitu612zFbYJRif8Dv8wisBg">
                </div>
            ...
            <div class="form-section">
                <form id="passwordForm">
                    ...
                    <div class="login-link">
                        <p>Remember your password? <a href="login.html" class="text-decoration-none fw-bold">Sign in here</a></p>
                    </div>
                </form>
            </div>
        </div>
        ...
        <footer>
            <p>Â© 2025 Pentagon Space Pvt. Ltd. All rights reserved.</p>
        </footer>
    </div>
